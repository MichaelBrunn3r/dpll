...
use dpll_cli::{cli::parse_num_worker_threads, generate::generate, solve::solve};
...
pub enum Command {
    Solve {
        ...
        #[arg(short = 'w', long = "worker-threads", value_name = "N", default_value = "1", value_parser = parse_num_worker_threads)]
